...
public class AppLayoutImpl implements AppLayout {
  ...
  public AppLayoutImpl() {
    mainMenu = EntrypointLayout001.getServiceLocator().getClientFactory().getMainMenuView();
...
public MainMenuViewImpl getMainMenu() {
	return mainMenu;
}

public void setMainMenu(MainMenuViewImpl mainMenu) {
